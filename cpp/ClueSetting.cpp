...
void clueSetting()
{
	...
	Clue card_num2;
	Clue card_num3;
	Clue safe1_1, safe1_2, safe1_3, safe1_4, safe1_5, safe1_6, safe1_7, safe1_8, safe1_9;
	
	/*safe*/
	safe1.set_clue(room_name, position_num, "safe1", 30, 180, 30, 180, 15.3917, -0.746502, 1.45153, 0, 180, 0, 2.0);
	...
	/*key*/
	key.set_clue(room_name, position_num, "key", 133, 14, 133, 14, -2 * DIST, 3 * DIST, -3 * DIST, 0, 0, 0, 2.0);
	key.add_3Dobj_path("D:\\resource\\3D\\key.obj");
	list_id.push_back(drawObject(glm_model, key, 0));
	ClueInRoom.push_back(key);

	/*card*/
	cardD.set_clue(room_name, position_num, "cardD", 133, 14, 133, 14, -12.2961, -9.70452, 16.0501, 0, 180, 0, 1.0);
	...
	card_num2.set_clue(room_name, position_num, "card_num2", 163, 44, 163, 44, 1.6*DIST, 0 * DIST, -3 * DIST, 0, 0, 0, 2.0);
	...
	card_num3.set_clue(room_name, position_num, "card_num3", 170, 50, 170, 50, 11.4248, -11.5602, 5.81321, 0, 0, 0, 2.0);
	...
	curtain.set_clue(room_name, position_num, "curtain", 142, 32, 142, 32, corner);
	ClueInRoom.push_back(curtain);


	/*pillow*/
	pillow.set_clue(room_name, position_num, "pillow", 0, 45, 0, 45, -0.5*DIST, 0.5*DIST, -3 * DIST, 0, 0, 0, 2.0);
	...
	Blue_shelf_Mid.set_clue(room_name, position_num, "Blue_shelf_Mid", 0, 45, 0, 45, -0.5*DIST, 0.5*DIST, -3 * DIST, 0, 0, 0, 2.0);
	...
	/*Orange*/
	Orange_shelf_Top.set_clue(room_name, position_num, "Orange_shelf_Top", 0, 45, 0, 45, -0.5*DIST, 0.5*DIST, -3 * DIST, 0, 0, 0, 2.0);
	ClueInRoom.push_back(Orange_shelf_Top);

	Orange_shelf_Mid.set_clue(room_name, position_num, "Orange_shelf_Mid", 0, 45, 0, 45, -0.5*DIST, 0.5*DIST, -3 * DIST, 0, 0, 0, 2.0);
	...
	/*Green*/
	Green_shelf_Top.set_clue(room_name, position_num, "Green_shelf_Top", 0, 45, 0, 45, -0.5*DIST, 0.5*DIST, -3 * DIST, 0, 0, 0, 2.0);
	ClueInRoom.push_back(Green_shelf_Top);

	Green_shelf_Mid.set_clue(room_name, position_num, "Green_shelf_Mid", 0, 45, 0, 45, -0.5*DIST, 0.5*DIST, -3 * DIST, 0, 0, 0, 2.0);
	...
	/*Wood*/
	Wood_shelf.set_clue(room_name, position_num, "Wood_shelf_Top", 0, 45, 0, 45, -0.5*DIST, 0.5*DIST, -3 * DIST, 0, 0, 0, 2.0);
	ClueInRoom.push_back(Wood_shelf);

	Wood_shelf_Top.set_clue(room_name, position_num, "Wood_shelf_Top", 0, 45, 0, 45, -0.5*DIST, 0.5*DIST, -3 * DIST, 0, 0, 0, 2.0);
	ClueInWoodShelf.push_back(Wood_shelf_Top);

	Wood_shelf_Mid.set_clue(room_name, position_num, "Wood_shelf_Mid", 0, 45, 0, 45, -0.5*DIST, 0.5*DIST, -3 * DIST, 0, 0, 0, 2.0);
	ClueInWoodShelf.push_back(Wood_shelf_Mid);

	Wood_shelf_bottom.set_clue(room_name, position_num, "Wood_shelf_bottom", 0, 45, 0, 45, -0.5*DIST, 0.5*DIST, -3 * DIST, 0, 0, 0, 2.0);
